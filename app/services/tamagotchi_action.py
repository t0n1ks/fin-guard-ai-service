...
_APOLOGY_PREFIXES = ["🌙 Back! ", "🛸 Again! ", "One more: "]


def _apply_apology(content: str) -> str:
    prefix = random.choice(_APOLOGY_PREFIXES)
